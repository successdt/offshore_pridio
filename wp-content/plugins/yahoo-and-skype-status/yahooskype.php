			...
			for($i=1;$i<= $this->_number;$i++){
				if(!empty($instance["nick_".$i])){
					if($instance["nick_type_".$i]=='yahoo')
					{
						...
						if($instance['is_show_name_'.$i])
							echo '<li><a href="skype:'.$instance["nick_".$i].'?chat" title="Talk with me via Skype "><img src="http://mystatus.skype.com/'.$instance["skype_status_type_".$i].'/'.$instance["nick_".$i].'"  alt="Talk with me via Skype" /> '.$instance["nick_name_".$i].'</a></li>';	
						else
							echo '<li><a href="skype:'.$instance["nick_".$i].'?chat" title="Talk with me via Skype "><img src="http://mystatus.skype.com/'.$instance["skype_status_type_".$i].'/'.$instance["nick_".$i].'"  alt="Talk with me via Skype" /></a></li>';		
						}
				}	
			}
			echo "</ul>";
